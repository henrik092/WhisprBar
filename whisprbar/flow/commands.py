...
COMMAND_SPECS = (
    ...
    CommandSpec("correct_english", "korrigiere mein englisch", "correct_english"),
    CommandSpec("correct_english", "korrigiere das englisch", "correct_english"),
    CommandSpec("humanize", "mach das menschlicher", "humanize"),
    CommandSpec("humanize", "mach das natürlicher", "humanize"),
    CommandSpec("humanize", "entferne den ki stil", "humanize"),
    CommandSpec("humanize", "entfern den ki stil", "humanize"),
    ...
    CommandSpec("correct_english", "correct my english", "correct_english"),
    CommandSpec("correct_english", "proofread my english", "correct_english"),
    CommandSpec("humanize", "humanize this", "humanize"),
    CommandSpec("humanize", "make this sound natural", "humanize"),
    CommandSpec("humanize", "remove the ai style", "humanize"),
